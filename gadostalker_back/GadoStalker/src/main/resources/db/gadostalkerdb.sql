...
VALUES  (1, NULL, '2022-06-08', 10, 'Clássico da culinária popular brasileira, o feijão tropeiro é gostoso, nutritivo, fácil de fazer e ainda serve de opção para dar uma cara nova àquele feijão que está esquecido na geladeira.', 9.90, 'Feijão Tropeiro', 1, 25),
        ...
        (6, NULL, '2021-06-01', 15, 'Quando aquecido, o grão do milho pipoca (Zea mays everta) estoura porque contém mais água (entre 12 e 16%) e tem casca mais resistente do que o milho comum.', 11.90, 'Milho pipoca', 5, 15),
...
INSERT INTO transacao (ID, ANUNCIOID, DATA_TRANSACAO, QUANTIDADE, PRECO) VALUES
